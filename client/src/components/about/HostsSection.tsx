    ...
    <section className="py-16 bg-[#F8F1E6]">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-['Playfair_Display'] font-bold mb-4">Meet Your Hosts</h2>
          <p className="text-[#8A8A8A] max-w-2xl mx-auto">
            Get to know the voices and hearts behind Heart & Household, bringing you authentic conversations about family life.
          </p>
        </div>
          ...
          {hosts.map((host) => (
            <div key={host.id} className="bg-white rounded-xl overflow-hidden shadow-md flex flex-col md:flex-row">
              ...
              <div className="p-6 md:w-3/5">
                ...
                <p className={`text-[${host.id === 1 ? '#B2593C' : '#858461'}] mb-4`}>{host.role}</p>
